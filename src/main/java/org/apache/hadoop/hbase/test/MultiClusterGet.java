...
public class MultiClusterGet {
	static final Log log = LogFactory.getLog(MultiClusterGet.class);
	...
	java -cp hbase.multicluster-0.2.0-SNAPSHOT.jar org.apache.hadoop.hbase.test.MultiClusterGet \
	...
	*/
	public static void main(String[] args) throws Exception {
		...
		/*cc.set("hbase.client.retries.number", "1");
		cc.set("hbase.client.pause", "1");
		cc.set("hbase.mcc.failover.mode", "true");
		cc.set("hbase.mcc.speculative.mutator", "false");*/
